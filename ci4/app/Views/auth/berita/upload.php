...
<div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" width="70%" src="<?= site_url('img/berita/thumb/' . 'thumb_' . $list['berita_sampul']) ?>" alt="Sampul Berita">
            </center>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="berita_sampul" name="berita_sampul" accept=".jpg,.jpeg,.png">
                        <div class="invalid-feedback error_berita_sampul">
        ...
        $('.btnupload').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.berita_sampul) {
                            $('#berita_sampul').addClass('is-invalid');
