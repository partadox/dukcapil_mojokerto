...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('gisa/subkategori_update', ['class' => 'formGKS']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="GKS_kategori_id" id="GKS_kategori_id" class="form-control">
                        ...
                        <?php foreach ($list_kategori as $key => $data) { ?>
                            <option value="<?= $data['GK_id'] ?>" <?php if ($data['GK_id'] == $GKS_kategori_id) echo "selected"; ?>><?= $data['GK_nama'] ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" id="GKS_id" value="<?= $GKS_id ?>" name="GKS_id" readonly>
                    <label>Nama Sub-Kategori Gisa</label>
                    <input type="text" class="form-control" id="GKS_nama" value="<?= $GKS_nama ?>" name="GKS_nama">
